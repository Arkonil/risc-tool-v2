...
def test_metric_repository_validate_json_all_present(data_repository):
    ...
    data = MetricRepositoryJSON(
        ...
        var_dev_unt_bad="credit_default_flag",
        var_dev_dlr_bad="credit_default_amount",
        var_dev_avg_bal="average_balance",
        var_tst_unt_bad="employment_status",
        var_tst_dlr_bad="credit_default_amount",
        var_tst_avg_bal="average_balance",
        current_rate_mob=12,
        lifetime_rate_mob=36,
        dev_data_source_ids=ds_ids,
        tst_data_source_ids=ds_ids,
    )

    invalid_metrics, missing_variables = MetricRepository.validate_json(
...
def test_metric_repository_validate_json_missing(data_repository):
    ...
    data = MetricRepositoryJSON(
        metrics={MetricID(0): bad_metric},
        var_dev_unt_bad="missing_var_field",
        var_dev_dlr_bad=None,
        var_dev_avg_bal=None,
        var_tst_unt_bad=None,
        var_tst_dlr_bad=None,
        var_tst_avg_bal=None,
        current_rate_mob=12,
        lifetime_rate_mob=36,
        dev_data_source_ids=ds_ids,
        tst_data_source_ids=ds_ids,
    ...
    assert missing_variables == ["missing_var_field"]
